...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-dark py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="add-user"> Tambah Data User </a>
                        <a class="collapse-item" href="table_produk"> Tambah Data Produk </a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"> Option <br> Riter Bakery </span>
                                <img class="img-profile rounded-circle"
                                    src="<?= NAMA_FOLDER ?>images/Riter.png">
                            </a>
    ...
    <!-- Page level plugins -->
    <script src="<?= FOLDER_DASHBOARD ?>vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="<?= FOLDER_DASHBOARD ?>js/demo/chart-area-demo.js"></script>
    <script src="<?= FOLDER_DASHBOARD ?>js/demo/chart-pie-demo.js"></script>
